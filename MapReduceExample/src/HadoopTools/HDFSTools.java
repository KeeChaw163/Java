...
public class HDFSTools {
	...
	public static void main(String[] args) throws URISyntaxException, IOException, ClassNotFoundException {
		...
		//ht.createDir("/datasets");
		//ht.getFileInfo("/yue/test.txt");
		//ht.uploadFileByStream("D:\\HADOOP\\MapRduceExample\\shanxi_cars.csv","/datasets/shanxi_cars.csv");
		//ht.uploadFile("D:\\test.txt","/huang");
		//ht.deleteFileAndDir("/results/results2");
		//ht.gzipCompressFile("D:\\test.txt","/test.gz");
		//ht.downloadFile("/huang/test.txt", "D:\\test9.txt");
	}
	...
	public static void getFileSystem() throws URISyntaxException, IOException {
		...
		uri = new URI("hdfs://192.168.29.10:8020");
		try {
	...
	/* 下载文件 */
	public void downloadFile(String srcPath, String dstPath) throws URISyntaxException, IOException {
		getFileSystem();
		Path src = new Path(srcPath);
		Path dst = new Path(dstPath);
